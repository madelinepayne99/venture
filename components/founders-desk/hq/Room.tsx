 ...
 * during the HQ carousel's slide (see HQView.tsx) — its Scout desk and
 * mission cards are still rendered (so the slide animates smoothly) but
 * are not reachable by click or keyboard until it becomes the active
 * room.
 */
    ...
    <div className="bg-hq-cream">
      <div className="relative aspect-[1000/520] w-full overflow-hidden">
        ...
        <div className="relative z-10 flex h-full flex-col px-8 pt-8">
          <p className="text-xs font-medium uppercase tracking-wide text-hq-ink/60">
            {project.name} · {roomLabel}
          </p>
          <div className="mt-auto flex flex-wrap items-end justify-between gap-6 pb-8">
